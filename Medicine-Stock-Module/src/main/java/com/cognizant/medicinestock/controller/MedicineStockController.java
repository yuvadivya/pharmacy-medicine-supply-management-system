...
public class MedicineStockController {
	...
	@ApiOperation(value="Gets medicine stock information")
	@ApiResponses(value = { 
	...
	@ApiOperation(value = "Gets list of medicines in stock according to target ailment")
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Suceess|OK"),
			@ApiResponse(code = 401, message = "not authorized!"), 
			@ApiResponse(code = 403, message = "forbidden!!!"),
	...
	@ApiOperation(value = "gets medicine deatails in medicinestock based on given name")
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Suceess|OK"),
			@ApiResponse(code = 401, message = "not authorized!"), 
			@ApiResponse(code = 403, message = "forbidden!!!"),
	...
	@ApiOperation(value = "updates medicine count in medicinestock based on given name")
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Suceess|OK"),
			@ApiResponse(code = 401, message = "not authorized!"), 
			@ApiResponse(code = 403, message = "forbidden!!!"),
