...
class MedRepScheduleServiceImplTest {
	...
	private static final Logger log = LoggerFactory.getLogger(MedRepScheduleServiceImplTest.class);
	...
	@Test
	public void testGetRepSchedule() {
		log.info("start...testGetRepSchedule()");
		assertNotNull(repSchedule);
		log.info("End...testGetRepSchedule()");
	}
}
